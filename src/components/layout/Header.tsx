...
export function Header() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white shadow-sm h-[100px]' : 'bg-transparent h-[140px]'
        }`}
    >
          ...
          <div className="flex-shrink-0 relative z-10">
            <a href="#inicio" className="flex items-center gap-2">
              <img
                ...
                className={`transition-all duration-300 ${isScrolled ? 'h-[84px]' : 'h-[120px]'} w-auto ${isScrolled ? '' : 'brightness-0 invert'}`}
              />
            </a>
          </div>
